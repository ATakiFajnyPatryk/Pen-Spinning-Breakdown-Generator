...
INSERT INTO trick (name, acronym, normality) VALUES ('Thumb Spin', NULL, 'Normal');

---------------------------------------------------- Thumb Spin 1.5 ----------------------------------------------------

BEGIN new_variant('Thumb Spin', 'Arounds & Spins', 3); END;
...
BEGIN new_variant('Thumb Spin', 'Arounds & Spins', 4); END;
