...
INSERT INTO trick (name, acronym, normality) VALUES ('Falling Fans', NULL, 'Normal');

----------------------------------------------------- Falling Fans -----------------------------------------------------

BEGIN new_variant('Falling Fans', 'Sonics & Charges', 2); END;
...
BEGIN new_variant('Falling Fans', 'Sonics & Charges', 3); END;
