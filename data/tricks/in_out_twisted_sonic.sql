...
BEGIN new_variant('In Out Twisted Sonic', 'Sonics & Charges', 2); END;
...
--------------------------------------- In Out Twisted Sonic Harmonic Reverse ------------------------------------------
