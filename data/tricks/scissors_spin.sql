...
INSERT INTO trick (name, acronym, normality) VALUES ('Scissor''s Spin', NULL, 'Normal');

-------------------------------------------------- Scissor's Spin 0.5 --------------------------------------------------

BEGIN new_variant('Scissor''s Spin', 'Arounds & Spins', 3); END;

BEGIN new_modification('0.5'); END;
...
BEGIN new_modification('1.0'); END;
