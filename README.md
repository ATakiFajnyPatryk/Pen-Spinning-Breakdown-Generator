...
Zachęcam do obejrzenia choćby fragmentu filmików z poniższych linków, aby mieć wyobrażenie, czym jest pen spinning. W pierwszym jest krótki popis profesjonalistów, a w drugim 160 przykładowych trików.

https://www.youtube.com/watch?v=voqYX8_VjvQ

https://www.youtube.com/watch?v=Xr8r2fjC3eo

Głównym celem projektu jest stworzenie generatora kombinacji trików pen spinningowych. Generator będzie tworzył sensowną kombinację spełniającą parametry wybrane przez użytkownika (przede wszystkim maksymalna trudność trików i ich ilość, ale nie tylko). Podaję również link do dość obszernej ksiązki (licencjonowanej Creative Commons) o pen spinningu. Gdy będę poniżej coś wyjaśniał, czasem podam numer strony/rozdziału w tej książce, gdzie można znaleźć dokładniejsze informacje. Zaglądanie tam nie jest konieczne, ale w razie ciekawości warto.

https://drive.google.com/file/d/1TlDb1H5bRnZZdswmdr07m-58yxs4Es7-/view

### Język

W pen spinningu powszechnie używa się angielskich nazw do wszystkiego i zmienianie ich na polskie odpowiedniki (nie zawsze łatwe do znalezienia) jest dość słabe. Mieszanie polskich i angielskich nazw również nie wygląda za dobrze. Dlatego realizuje projekt całkowicie w języku angielskim, z wyjątkiem tego opisu.
...
Tabela variant_in_combo realizuje klasę combo z diagramu UML i związek tej klasy z klasą variant. Atrybuty combo_id i variant_id pozwalają stwierdzić, do której kombinacji należy i którym wariantem jest dany rekord w tej tabeli. Parametr position oznacza pozycję wariantu w kombinacji, czyli którym z kolei wariantem do wykonania jest dany wariant.
...
Przyda się również tekst wyjaśniający notację używaną przez generator, ale to również formalność.
